...
export function ScoreRow({ scores, matched, size = "lg" }: ScoreRowProps) {
  ...
  return (
    <ol className={cn("num flex items-baseline gap-6 border-b border-line pb-3 font-display", size === "lg" ? "text-5xl" : "text-3xl")} aria-label="Your last five scores, newest first">
