...
|---|---|---|---|
| A1 | **Live website** — publicly accessible, on a *new* Vercel account | `https://kindscore-<x>.vercel.app` (custom domain optional) | **Assignment link** |
...
| A4 | **Database** — *new* Supabase project with proper schema | Migrations in repo (`supabase/migrations/`), seed script, schema diagram | Repo + submission PDF |
